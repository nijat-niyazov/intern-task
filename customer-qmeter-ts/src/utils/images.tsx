...
import om from '../assets/images/oman.png';
...
/*
 ! This file must have same path with element in which file images will be used. Because  importing pathes must be same
 */
